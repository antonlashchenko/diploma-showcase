...
import { getProductsWithImages } from './actions'; // Імпортуємо наш серверний екшн
  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 sm:px-6 py-12">
        ...
        {loading ? (
          <div className="text-center py-10">Завантаження товарів...</div>
        ) : (
            ...
            {filteredProducts.map((product) => (
              ...
              >
                <div className="h-48 w-full flex items-center justify-center p-4 relative">
                   {/* Відображаємо знайдене головне фото */}
                  <img 
                    src={product.mainImage} 
                    alt={product.title} 
                    className="h-48 w-full object-contain p-4 transition-transform group-hover:scale-105"
                  />
                </div>
