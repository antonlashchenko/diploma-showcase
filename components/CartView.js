...
// 1. Отримуємо 'categories' від серверної сторінки
export default function CartView({ categories }) {
  const { items, removeFromCart, getTotalPrice } = useCart();
  
  // Цей стан потрібен, щоб Хедер працював
